#ifndef HALIDE__erode_arm_32_linux_h
#define HALIDE__erode_arm_32_linux_h
#include <stdint.h>
...
int erode_halide(struct halide_buffer_t *_p0_buffer, struct halide_buffer_t *_f0_buffer) HALIDE_FUNCTION_ATTRS;
int erode_halide_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *erode_halide_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return erode_halide_metadata;
}
#endif


int erode_halide_old_buffer_t(struct buffer_t *_p0, struct buffer_t *_f0) HALIDE_FUNCTION_ATTRS;
